...
<h3>Produk.html</h3>
<p>produk.html berfungsi sebagai halaman katalog utama pada website. Halaman ini diawali dengan deklarasi <!DOCTYPE html> dan elemen <html> yang menandakan bahwa dokumen menggunakan HTML5. Bagian <head> memuat pengaturan penting seperti charset UTF-8 agar teks tampil dengan benar, viewport supaya halaman responsif di perangkat mobile, dan title untuk menampilkan judul di tab browser. Pada bagian <body>, latar belakang diatur berwarna abu-abu muda menggunakan atribut style. Bagian header menggunakan tabel untuk meletakkan logo di sisi kiri dan judul toko di sisi tengah, dilengkapi dengan garis <hr> sebagai pemisah. Di bawahnya terdapat navigasi <nav> berisi link menuju halaman Beranda, Produk, dan Tentang Kami agar pengguna bisa berpindah halaman dengan mudah. Bagian utama halaman ditandai dengan tag <main> yang menampilkan judul "PRODUK UNGGULAN", kemudian sebuah tabel menampilkan daftar produk dalam tiga kolom. Setiap kolom berisi gambar produk, link menuju halaman detail produk masing-masing (ROG, iPhone, Samsung), dan harga yang ditampilkan dalam teks tebal. Terakhir, terdapat footer yang memberikan informasi hak cipta dan kontak toko, sehingga pengguna bisa menghubungi jika perlu.</p>
<br>
